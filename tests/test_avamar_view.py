...
class TestAvamarView(unittest.TestCase):
    ...
    def test_v1_deprecated(self):
        """AvamarView - GET on /api/1/inf/avamar returns an HTTP 404"""
        resp = self.app.get('/api/1/inf/avamar',
    ...
    def test_get_task(self):
        """AvamarView - GET on /api/2/inf/avamar returns a task-id"""
        resp = self.app.get('/api/2/inf/avamar',
                            headers={'X-Auth': self.token})
    ...
    def test_get_task_link(self):
        """AvamarView - GET on /api/2/inf/avamar sets the Link header"""
        resp = self.app.get('/api/2/inf/avamar',
                            headers={'X-Auth': self.token})

        task_id = resp.headers['Link']
        expected = '<https://localhost/api/2/inf/avamar/task/asdf-asdf-asdf>; rel=status'

        self.assertEqual(task_id, expected)

    def test_post_task(self):
        """AvamarView - POST on /api/2/inf/avamar returns a task-id"""
        resp = self.app.post('/api/2/inf/avamar',
                             headers={'X-Auth': self.token},
    ...
    def test_post_task_link(self):
        """AvamarView - POST on /api/2/inf/avamar sets the Link header"""
        resp = self.app.post('/api/2/inf/avamar',
                             headers={'X-Auth': self.token},
                             json={'network': "someLAN",
                                   'name': "myAvamarBox",
    ...
    def test_delete_task(self):
        """AvamarView - DELETE on /api/2/inf/avamar returns a task-id"""
        resp = self.app.delete('/api/2/inf/avamar',
                               headers={'X-Auth': self.token},
    ...
    def test_delete_task_link(self):
        """AvamarView - DELETE on /api/2/inf/avamar sets the Link header"""
        resp = self.app.delete('/api/2/inf/avamar',
                               headers={'X-Auth': self.token},
                               json={'name' : 'myAvamarBox'})
    ...
    def test_image(self):
        ...
        resp = self.app.get('/api/2/inf/avamar/image',
                            headers={'X-Auth': self.token})
