...
class TestAvamarViewSchema(unittest.TestCase):
    """A set of test cases for the schemas of /api/1/inf/avamar"""

    def test_post_schema(self):
        """The schema defined for POST on is valid"""
        try:
            Draft4Validator.check_schema(avamar.AvamarView.POST_SCHEMA)
            schema_valid = True
        except RuntimeError:
            schema_valid = False
    ...
    def test_get_schema(self):
        ...
        try:
            Draft4Validator.check_schema(avamar.AvamarView.GET_SCHEMA)
            schema_valid = True
        except RuntimeError:
            schema_valid = False
    ...
    def test_delete_schema(self):
        ...
        try:
            Draft4Validator.check_schema(avamar.AvamarView.DELETE_SCHEMA)
            schema_valid = True
        except RuntimeError:
            schema_valid = False
    ...
    def test_iamges_schema(self):
        ...
        try:
            Draft4Validator.check_schema(avamar.AvamarView.IMAGES_SCHEMA)
            schema_valid = True
        except RuntimeError:
            schema_valid = False
