...
DEFINED = OrderedDict([
            ('VLAB_AVAMAR_LOG_LEVEL', environ.get('VLAB_AVAMAR_LOG_LEVEL', 'INFO')),
            ...
            ('VLAB_MESSAGE_BROKER', environ.get('VLAB_MESSAGE_BROKER', 'avamar-broker')),
            ('VLAB_URL', environ.get('VLAB_URL', 'https://localhost')),
            ('VLAB_AVAMAR_IMAGES_DIR', environ.get('VLAB_AVAMAR_IMAGES_DIR', '/images')),
